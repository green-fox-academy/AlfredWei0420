...
window.addEventListener('load', function() {
  buttonElements
    ...
    .forEach(function(buttonElement,i) {
      document.body.appendChild(buttonElement);
      buttonElement.addEventListener('click', function(event){
       console.log(buttonElement.dataset.vehicleType);
       if(buttonElement.dataset.vehicleType === "car"){
        car.printMaxSpeed();
        } else if(buttonElement.dataset.vehicleType === "airplane") {
...
//When the user clicks on a button, the maxspeed of the appropriate vehicle should be logged to the console.
